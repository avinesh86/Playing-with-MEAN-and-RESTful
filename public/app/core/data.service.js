...
var DataService = (function () {
    ...
    DataService.prototype.getDepartments = function () {
        ...
        return this.http.get(this.departmentURI)
            ...
            _this.calculateCustomersOrderTotal(departments);
            return departments;
        })
            .catch(this.handleError);
    };
    DataService.prototype.getDepartmentsPage = function (page, pageSize) {
        var _this = this;
    ...
    DataService.prototype.insertDepartment = function (department) {
